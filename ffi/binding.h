...
enum OwlchatResult owlchat_crypto_init(void);
...
enum OwlchatResult owlchat_crypto_destory(void);
...
enum OwlchatResult owlchat_crypto_dispatch(int64_t port, const uint8_t *data, uintptr_t len);
#endif
...
struct Buffer owlchat_crypto_dispatch(const uint8_t *data, uintptr_t len);
#endif
